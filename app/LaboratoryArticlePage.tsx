  ...
  return <main className="laboratory-article-page">
    ...
    <article className="laboratory-article shell">
      ...
      <div className="laboratory-article-hero">
        ...
        <figure className={`laboratory-article-cover${article.imageFit === "contain" ? " contain" : ""}`}><img src={article.image} alt={article.title} /><figcaption>{article.imageCaption || "實驗室環境圖片；設備型號與測試數據待確認。"}</figcaption></figure>
      </div>
