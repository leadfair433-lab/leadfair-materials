...
export default function ArticlesPage() {
  ...
  return <main className="article-hub">
    <nav className="article-hub-nav shell" aria-label="文章中心導航"><a href="/#blog">← 返回首頁</a><span>ADVANCED MATERIALS</span><div className="localized-nav-actions"><LanguageSwitcher compact/><a href="/#product">檢視材料牌號 ↗</a></div></nav>
    <div className="shell">
