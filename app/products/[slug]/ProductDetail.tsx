...
export default function ProductPage() {
  ...
  return <main className="product-page">
    <header className="top shell"><a className="logo" href="/"><i>R</i><span>原料網站<small>ADVANCED MATERIALS</small></span></a><div className="localized-nav-actions"><LanguageSwitcher compact/><a className="product-back" href="/#materials">返回首頁 ↗</a></div></header>
    ...
    <footer className="footer shell"><a className="logo" href="/"><i>R</i><span>原料網站<small>ADVANCED MATERIALS</small></span></a><p>Advanced thermoplastic material solutions for global manufacturing.</p></footer>
  </main>;
}
